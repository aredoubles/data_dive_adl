...
* Data Tables;
*------------------------------------------------------------*;
%let Ids2_data = SASUSER.HATESAMPLE;
%let Ids2_newdata =;
%let Ids_data = SASUSER.TEST;
%let Ids_newdata =;
*------------------------------------------------------------*;
%end;
%global Ids2_source;
...
run;
*------------------------------------------------------------*;
* Decmeta Data Set for Ids2;
*------------------------------------------------------------*;
data WORK.Ids2_Hate_crime_DM;
  length   _TYPE_                           $ 32
           VARIABLE                         $ 32
           LABEL                            $ 256
           LEVEL                            $ 32
...
output;
_TYPE_="PREDICTED";
VARIABLE="P_Hate_crime1";
LABEL="Predicted: Hate_crime=1";
LEVEL="1";
EVENT="";
ORDER="";
FORMAT="";
...
output;
_TYPE_="RESIDUAL";
VARIABLE="R_Hate_crime1";
LABEL="Residual: Hate_crime=1";
LEVEL="1";
EVENT="";
ORDER="";
FORMAT="";
...
output;
_TYPE_="PREDICTED";
VARIABLE="P_Hate_crime0";
LABEL="Predicted: Hate_crime=0";
LEVEL="0";
EVENT="";
ORDER="";
FORMAT="";
...
output;
_TYPE_="RESIDUAL";
VARIABLE="R_Hate_crime0";
LABEL="Residual: Hate_crime=0";
LEVEL="0";
EVENT="";
ORDER="";
FORMAT="";
...
output;
_TYPE_="FROM";
VARIABLE="F_Hate_crime";
LABEL="From: Hate_crime";
LEVEL="";
EVENT="";
ORDER="";
FORMAT="";
...
output;
_TYPE_="INTO";
VARIABLE="I_Hate_crime";
LABEL="Into: Hate_crime";
LEVEL="";
EVENT="";
ORDER="";
FORMAT="";
...
run;
*------------------------------------------------------------*;
* Decdata Data Set for Ids2;
*------------------------------------------------------------*;
data WORK.Ids2_Hate_crime_DD;
  length   Hate_crime                       $ 32
           COUNT                              8
           DATAPRIOR                          8
           TRAINPRIOR                         8
           DECPRIOR                           8
...
Hate_crime="1";
COUNT=10;
DATAPRIOR=0.52631578947368;
TRAINPRIOR=0.52631578947368;
DECPRIOR=.;
DECISION1=1;
DECISION2=0;
output;
Hate_crime="0";
COUNT=9;
DATAPRIOR=0.47368421052631;
TRAINPRIOR=0.47368421052631;
DECPRIOR=.;
DECISION1=0;
DECISION2=1;
output;
...
output;
id= "Ids2";
property="EM_DECMETA_Hate_crime";
value= "WORK.Ids2_Hate_crime_DM";
output;
id= "Ids2";
property="EM_DECDATA_Hate_crime";
value= "WORK.Ids2_Hate_crime_DD";
output;
id= "Ids2";
property="EM_FILE_EMNOTES";
